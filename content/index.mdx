...
- Act Order (the intended order): Start with the [Prologue](./lastcontact/prologue) and read the first chapter. Use the navigation links at the bottom of the page to proceed to the next chapter throughout the book.
- Chronological Order: You can use the [Timeline](./lastcontact/compendium/timeline.mdx) to see a chronological list of all the chapters across acts. Come back to the timeline after each chapter.
